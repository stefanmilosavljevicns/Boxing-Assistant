...
public class GetWorkoutByName {
    ...
    public GetWorkoutByName(String name, ArrayList<String> moves, ArrayList<Long> movesTime, int roundNumber, int roundMin, int roundSec, int restMin, int restSec, int prepareMin, int prepareSec) {
        this.name = name;
        this.moves = moves;
        this.movesTime = movesTime;
        this.roundNumber = roundNumber;
